...
The mean and median number of steps taken per day are `r print(meanTotal)` and `rprint(medianTotal)`, respectively.
...
On average, the 5-minute interval of `r print(maxInterval)` contained the the most steps.
...
The mean and median number of steps taken per day are `r print(meanTotal_noNA)` and `rprint(medianTotal_noNA)`, respectively.
